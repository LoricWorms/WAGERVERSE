...
- **Refined Admin UX:** Replaced inline edit forms with modal dialogs (`Dialog` from shadcn/ui) for a cleaner and more focused management experience.
- **Tournament Management:** Implemented full CRUD (Create, Read, Update, Delete) functionality for tournaments within the admin panel.
